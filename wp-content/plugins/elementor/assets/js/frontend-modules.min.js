...
(self.webpackChunkelementor = self.webpackChunkelementor || []).push([[354], {
    ...
    32: (e,t,n)=>{
        ...
        class NestedAccordion extends i.default {
            ...
            interlaceContainers() {
                const {$contentContainers: e, $items: t} = this.getDefaultElements();
                e.each(((e,n)=>{
                    t[e].appendChild(n)
                }
                ))
    ...
    7323: (e,t,n)=>{
        ...
        class NestedTabs extends i.default {
            ...
            onElementChange(e) {
                this.checkSliderPropsToWatch(e) && this.setHorizontalScrollAlignment()
            }
            ...
            changeScrollStatus(e) {
                ...
                "mousedown" === e.type ? (t.classList.add("e-scroll"),
                t.dataset.pageX = e.pageX) : (t.classList.remove("e-scroll"),
                t.classList.remove("e-scroll-active"),
                t.dataset.pageX = "")
            }
            isHorizontalScroll() {
                const e = this.elements.$headingContainer[0];
                return e.clientWidth < this.getChildrenWidth(e.children) && "enable" === this.getHorizontalScrollSetting()
            }
            getChildrenWidth(e) {
                let t = 0;
            ...
            setHorizontalScrollAlignment() {
                ...
                if (this.isHorizontalScroll()) {
                    ...
                    e.style.setProperty("--n-tabs-heading-justify-content", "")
            }
            getTabsDirection() {
            ...
            initialScrollPosition(e, t) {
                ...
                if ("end" === t)
                    ...
                    e.scrollLeft = n ? -1 * this.getChildrenWidth(e.children) : this.getChildrenWidth(e.children);
                else
                    e.style.setProperty("--n-tabs-heading-justify-content", "start"),
                    e.scrollLeft = 0
            }
    ...
    ,
    1448: (e,t,n)=>{
        var r, i, s = n(2086), o = n(4999), a = s.process, l = s.Deno, c = a && a.versions || l && l.version, u = c && c.v8;
    ...
    5070: (e,t,n)=>{
        ...
        e.exports = function(e, t, n) {
            var o, a;
            return s && r(o = t.constructor) && o !== n && i(a = o.prototype) && a !== n.prototype && s(e, a),
            e
        }
    }
    ,
    ...
    ,
    3278: (e,t,n)=>{
        var r, i, s, o = n(640), a = n(2086), l = n(8759), c = n(2585), u = n(9606), d = n(4489), h = n(8944), g = n(7153), p = "Object already initialized", f = a.TypeError, m = a.WeakMap;
        if (o || d.state) {
    ...
    1557: (e,t,n)=>{
        ...
        e.exports = function(e, t, n, m) {
            ...
            if (w) {
                ...
                if (E.prototype = C,
                "Error" !== S ? a ? a(E, T) : l(E, T, {
                    name: !0
                }) : p && v in w && (c(E, w, v),
                c(E, w, "prepareStackTrace")),
                l(E, w),
                !f)
                    try {
                        C.name !== S && s(C, "name", S),
